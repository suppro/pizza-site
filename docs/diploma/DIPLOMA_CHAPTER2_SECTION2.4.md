...
Модуль каталога товаров обеспечивает отображение товаров, поиск, фильтрацию и навигацию по категориям. Реализация выполнена с использованием паттерна MVC и оптимизирована для работы с большим количеством товаров [6; 11; 20].
...
Корзина хранится в сессии пользователя в виде ассоциативного массива, где ключом является ID товара, а значением – массив с данными товара и количеством [11; 20].
...
Интеграция с системой 1С реализована через сервисный класс `OneCService`, который инкапсулирует всю логику взаимодействия с API 1С [6; 10; 14].
